...
public class Shapes implements Serializable {
    ...
    public Shapes(Graphics g, int x, int y, int x1, int y1, String type, Color c,Stroke stroke)
    {
        this.x = x;
        this.y = y;
        this.x1 = x1;
    ...
    public Shapes(Graphics g, ArrayList<Point> s, String type, Color c,Stroke stroke)
    {
        this.freedraw = s;
        this.type = type;
        this.c = c;
    ...
    public Shapes(Graphics g, int x, int y, String in, String type, Color color)
    {
        this.x =x;
        this.y = y;
        this.input = in;
